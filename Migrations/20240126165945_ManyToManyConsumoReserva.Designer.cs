...
namespace HotelEF.Migrations
{
    ...
    [Migration("20240126165945_ManyToManyConsumoReserva")]
    partial class ManyToManyConsumoReserva
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelEF.Consumo", b =>
                {
            ...
            modelBuilder.Entity("HotelEF.ConsumoReserva", b =>
                {
                    b.Property<int>("ConsumoID")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ConsumoID", "ReservasReservaID");
            ...
            modelBuilder.Entity("HotelEF.ServicoReserva", b =>
                {
                    b.Property<int>("ReservasReservaID")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ReservasReservaID", "ServicoID");
            ...
            modelBuilder.Entity("HotelEF.ConsumoReserva", b =>
                {
                    b.HasOne("HotelEF.Consumo", "Consumo")
                        .WithOne()
                        .HasForeignKey("HotelEF.ConsumoReserva", "ConsumoID")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("HotelEF.Reserva", "Reserva")
                        .WithOne()
                        .HasForeignKey("HotelEF.ConsumoReserva", "ReservaID")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("HotelEF.Reserva", null)
                        .WithMany()
            ...
            modelBuilder.Entity("HotelEF.ServicoReserva", b =>
                {
                    b.HasOne("HotelEF.Reserva", "Reserva")
                        .WithOne()
                        .HasForeignKey("HotelEF.ServicoReserva", "ReservaID")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                    ...
                    b.HasOne("HotelEF.Servico", "Servico")
                        .WithOne()
                        .HasForeignKey("HotelEF.ServicoReserva", "ServicoID")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
